    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-sm-12 liste-livreur">
                <span class="tab_btn btn_actif col-sm-2 col-sm-offset-2" id="tab1_btn" onclick="show_div('tab1');">Shift Avant 14h</span>
            ...
            <div class="row">
                ...
                <div class="col-sm-6">
                    <div class="panel panel-default">
                        ...
                        <div id="div_tab_resultat" class="panel-body">
                            <a class="btn btn-light-grey" style="margin-top:0;" target="_blank" href="action_poo.php?action=export_activite_one">Exporter en CSV</a>
                ...
                <div class="col-sm-6">
                    <div class="panel panel-default">
                        ...
                        <div id="div_tab_resultat" class="panel-body">
                            <a class="btn btn-light-grey" style="margin-top:0;" target="_blank" href="action_poo.php?action=export_connectLivreur_one">Exporter en CSV</a>
            ...
            <div class="row">
                <div class="col-sm-6">
                    <div class="panel panel-default">
                        ...
                        <div id="div_tab_resultat" class="panel-body">
                            <a class="btn btn-light-grey" style="margin-top:0;" target="_blank" href="action_poo.php?action=export_activite_two">Exporter en CSV</a>
                ...
                <div class="col-sm-4">
                    <div class="panel panel-default">
                        ...
                        <div id="div_tab_resultat" class="panel-body">
                            <a class="btn btn-light-grey" style="margin-top:0;" target="_blank" href="action_poo.php?action=export_connectLivreur_two">Exporter en CSV</a>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-body" style="text-align:center">
                        ...
                        <form action="coordination.php?">
                            <div style="padding:10px">
                                <p><b>Etes-vous sur de vouloir mettre en ligne <?php ?></b></p>
                                <div class="col-sm-6 change_planning">
