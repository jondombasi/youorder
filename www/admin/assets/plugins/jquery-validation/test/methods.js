...
test("phoneUK", function() {
	...
	ok( method( "07222 555555" ), "Valid UK PhoneNumber Number" );
	ok( method( "(07222) 555555" ), "Valid UK PhoneNumber Number" );
	ok( method( "+44 7222 555 555" ), "Valid UK PhoneNumber Number" );
	ok(!method( "7222 555555" ), "Invalid UK PhoneNumber Number" );
	ok(!method( "+44 07222 555555" ), "Invalid UK PhoneNumber Number" );
});
